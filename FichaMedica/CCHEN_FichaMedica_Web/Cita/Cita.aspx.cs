...
namespace CCHEN_FichaMedica_Web.Cita
{
    public partial class Cita : System.Web.UI.Page
    {
        ...
        protected void btn_verpaciente_clic(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../RegistroClinico/Paciente.aspx?rut=" + DropDownList_NombrePaciente_detalle.SelectedValue.ToString());
        ...
        {
            string BuscarCita = "RC_Accion_BuscarCita";
            string NuevaCita = "RC_Accion_NuevaCita";
            string GrabarNuevaCita = "RC_Accion_GrabarNuevaCita";
            string ModificarCita = "RC_Accion_ModificarCita";
            string EliminarCita = "RC_Accion_EliminarCita";

            if (ControlDisplay(BuscarCita)) btn_buscar.Visible = true; else btn_buscar.Visible = false;
            if (ControlDisplay(NuevaCita)) btn_nuevacita.Visible = true; else btn_nuevacita.Visible = false;
            if (ControlDisplay(GrabarNuevaCita)) btn_grabar_nuevacita.Visible = true; else btn_grabar_nuevacita.Visible = false;
            if (ControlDisplay(ModificarCita)) btn_modificar.Visible = true; else btn_modificar.Visible = false;
            if (ControlDisplay(EliminarCita)) btn_eliminar.Visible = true; else btn_eliminar.Visible = false;
        }
