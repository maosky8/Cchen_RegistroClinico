...
namespace CCHEN_FichaMedica_Web.RegistroClinico
{
    public partial class NuevoPaciente : System.Web.UI.Page
    {
        ...
        {
            string NuevoPaciente = "RC_Accion_GrabarNuevoPaciente";
            if (ControlDisplay(NuevoPaciente)) btn_grabar_paciente.Visible = true; else btn_grabar_paciente.Visible = false;
        }
