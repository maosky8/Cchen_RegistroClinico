...
<div class="panel panel-info" id="div_nueva" runat="server" visible="false">
    ...
    <div class="panel-body">
        ...
        <div id="div_" class="form-group" runat="server">
            ...
            <div class="col-sm-3"><label for="inputName" class="control-label" required>Hora Cita :</label></div>
            <div class="col-sm-3"><asp:DropDownList ID="DropDownList_nc_horacita" runat="server" class="form-control" onselectedindexchanged="DropDownList_nc_horacita_SelectedIndexChanged"></asp:DropDownList></div>
            
            <div class="col-sm-3"><label for="inputName" class="control-label" required>Tipo Cita :</label></div>
            <%--<div class="col-sm-3"><asp:TextBox id="txt_tipocita_detalle" runat="server" class="form-control"></asp:TextBox></div>--%>
            <div class="col-sm-3"><asp:DropDownList ID="DropDownList_nc_tipocita" runat="server" class="form-control" onselectedindexchanged="DropDownList_nc_TipoCita_SelectedIndexChanged"></asp:DropDownList></div>
            ...
            <div class="col-sm-3"><label for="inputName" class="control-label">Estado Cita :</label></div>
            <div class="col-sm-3"><asp:DropDownList ID="DropDownList_nc_estadocita" runat="server" class="form-control" onselectedindexchanged="DropDownList_nc_EstadoCita_SelectedIndexChanged"></asp:DropDownList></div>
