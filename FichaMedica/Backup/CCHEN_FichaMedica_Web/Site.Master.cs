...
namespace CCHEN_FichaMedica_Web
{
    public partial class SiteMaster : System.Web.UI.MasterPage
    {
        ...
        protected void CargaMenu(string usuario)
        {
            ...
            string menuCita = "REG_CLI_Menu_Cita";
            ...
            if (tareaCita.Tables[0].Rows.Count != 0) { idlicita.Visible = true; }

            string menuRegCli = "REG_CLI_Menu_Registro_Clinico";
            ...
            if (tareaRegCli.Tables[0].Rows.Count != 0) { idliregcli.Visible = true; }
